...
android {
    namespace = "com.kidsgames.matchshapes"
...
dependencies {
    // Leafness: this module may depend ONLY on core:gameapi and
    // core:designkit. Never core:shell, :app, or another :games:* module.
